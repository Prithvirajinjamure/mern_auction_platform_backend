...
const CardTwo = ({imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
        ...
        className=" basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80"
      >
        <img
          src={imgSrc}
          alt={title}
        ...
        <div className="px-2 pt-4 pb-2">
...

          {
            <div className="flex flex-col gap-2 mt-4">
              <button
                className="w-full bg-[#222] text-white py-2 rounded mb-2 hover:bg-[#444] transition-all duration-300"
                onClick={() => navigate(`/auction/details/${id}`)}
              >
                View Auction
              </button>
      ...
      <section className= {`fixed ${openDrawer && id ? "bottom-0": "-bottom-full"} left-0 w-full transition-all duration-300 h-full bg-[#00000087] flex items-end`}>
        <div className="bg-white h-fit transition-all duration-300 w-full">
          <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
            <h3 className="text-[#D6482B] text-3xl font-semibold text-center mb-1">Republish Auction</h3>

            <p className="text-stone-900">Let's Republish auction with same details but new starting and ending time</p>
            ...
            <form className="flex flex-col gap-5 my-5">
              ...
              <div>
                <button className="bg-blue-500 flex justify-center w-full py-2 rounded-md text-white fontsemibold text-xl transition-all duration-300 hover:bg-blue-700" type="button"
              ...
              <div>
                 <button className="bg-yellow-500 flex justify-center w-full py-2 rounded-md text-white fontsemibold text-xl transition-all duration-300 hover:bg-yellow-700" type="button"
