import {
    ...
    return (
      <>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white/90 mt-5 rounded-xl shadow-lg border border-[#e0e7ff]">
            <thead className="bg-gradient-to-r from-[#4fdac7] to-[#d6482b] text-white">
              <tr>
                <th className="w-1/3 py-3 rounded-tl-xl">User ID</th>
                <th className="w-1/3 py-3">Status</th>
                <th className="w-1/3 py-3 rounded-tr-xl">Actions</th>
              </tr>
            </thead>
  ...
  export const Drawer = ({ setOpenDrawer, openDrawer }) => {
    ...
    // Define the missing handleClose function
    ...
    return (
      <>
        <section
          ...
          }  left-30   w-full transition-all duration-300 h-50% bg-[#00000087] flex items-end`}
        >
          <div className="bg-white h-fit  transition-all duration-300 w-full">
            <div className="w-96% px-5 py-8 sm:max-w-[640px] sm:m-auto">
